...
function PilotPanel() {
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      "div",
      { style: barStyle },
      import_react.default.createElement("span", { style: { fontSize: 13, fontWeight: 700 } }, "\u{1F6E9}\uFE0F \u6D4F\u89C8\u5668\u9A7E\u9A76\u8231"),
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement("button", { style: btnStyle, disabled: busy, onClick: () => run("start") }, "\u25B6 \u542F\u52A8"),
      import_react.default.createElement("button", { style: btnStyle, disabled: busy, onClick: () => run("stop") }, "\u25A0 \u5173\u95ED"),
      ...
      import_react.default.createElement("button", { style: btnStyle, disabled: busy || !/^https?:\/\//.test(navUrl), onClick: () => run("navigate", { url: navUrl }) }, "\u524D\u5F80")
    ),
